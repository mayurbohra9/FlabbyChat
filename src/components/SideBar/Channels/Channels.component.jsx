...
const Channels = (props) => {
    ...
    return <> <Menu.Menu style={{ marginTop: '10px' }}>
        <Menu.Item style={{fontSize : '17px'}} className='list_tag'>
            <span>
        ...
        <Modal open={modalOpenState} onClose={closeModal}>
            ...
            <Modal.Actions>
                <Button loading={isLoadingState} onClick={onSubmit} style={{background : "#1164A3", color:"white"}}>
